  ...
  >
    ...
    <div class="text-white relative z-10 flex justify-between items-center min-h-[64px]">
      ...
      <div class="flex flex-col flex-1 pr-4">
        ...
        <span v-if="isTaken && note" class="text-white/85 font-semibold text-xs mt-1.5 leading-snug normal-case whitespace-pre-line">
          {{ note }}
        </span>
      </div>
      ...
      <div class="flex flex-col items-end shrink-0 pl-4 border-l border-white/20">
        <div v-if="isTaken" class="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center animate-in fade-in zoom-in duration-300 shadow-inner">
